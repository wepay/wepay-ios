...
/**
 *  The transaction certificate that certifies the transaction.
 */
@property (nonatomic, strong, readonly) NSString* transactionCertificate;
 ...
 *  @param transactionCertificate The transaction certificate that certifies the transaction
...
- (instancetype) initWithAmount:(double) amount
         ...
         transactionCertificate:(NSString *)transactionCertificate
