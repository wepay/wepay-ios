Pod::Spec.new do |s|
  ...
  s.authors           = { 'Chaitanya Bagaria' => 'chaitanya.bagaria+wepayios@wepay.com' }
  ...
  s.vendored_frameworks  = 'WePay.framework', 'G4XSwiper.framework', 'RPx.framework', 'RUA.framework', 'TrustDefenderMobile.framework'
